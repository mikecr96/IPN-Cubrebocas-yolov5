...
def run(
    ...
    names = ['Incorrecto', 'NO Uso', 'Uso']
    colors = [[0,200,200], [0,0,255], [0,255,0]]
...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "weights/cubrebocas5s-int8.tflite", help="model path or triton URL")
    ...
    parser.add_argument("--project", default="/tmp/yolov5scubrebocas", help="save results to project/name")
